...
def main():
    ...
    config = Configuration(
        ...
        instant_activities={"A_ACCEPTED", "O_SELECTED","A_FINALIZED","O_CREATED","O_SENT"},
        outlier_statistic=OutlierStatistic.MEDIAN,
        outlier_threshold=outlier_threshold
    )
    run_estimation("../event_logs/bpi_2012_100k.csv", config,
                   "../event_logs/bpi_2012_100k_estimated.csv".format(folder))
